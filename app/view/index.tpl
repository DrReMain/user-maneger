...
<head>
    ...
    <style rel="stylesheet">
        ...
        .view {
            background: url("../public/MDBPro/img/index.jpeg") no-repeat center center fixed;
...
<div class="view hm-black-strong">
    <div class="full-bg-img flex-center">
        <ul class="animated fadeInUp">
            <li>
                <h1 class="h1-responsive">☺</h1></li>
            <li>
                <p>keep learning & share!</p>
            </li>
            <li>
                <a href="/home" class="btn btn-primary btn-lg" rel="nofollow">BLOG</a>
                <a target="_blank" href="https://github.com/DrReMain" class="btn btn-info btn-lg" rel="nofollow"> <i
